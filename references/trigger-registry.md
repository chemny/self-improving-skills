...
This registry tracks trigger phrase groups for `self-improving-skills`. Keep most trigger variants here. Promote only stable, high-value groups to `SKILL.md` frontmatter description.
...
| replacement_consolidation | 替换掉其他自我更新 skill; 合并 self-improving; 迁移 self-reflection; 废弃旧记忆 skill; consolidate memory skills | replacement | active | Added after user chose Self-Improving Skills as the single controller | 2026-05-29 | Read replacement-strategy.md; do not delete old skills without confirmation |
